...
class RtisTests(unittest.TestCase):
    ...
    def test_train_search_filters_full_dataset_and_excel(self):
        ...
        loco_page = self.client.get('/rtis', params={'loco_no': '2236'})
        self.assertEqual(loco_page.context['total'], 101)
        self.assertEqual(loco_page.context['loco_no'], '2236')
        self.assertIn('name="loco_no"', loco_page.text)
        self.assertEqual(self.client.get('/rtis', params={'loco_no': 'not-found'}).context['total'], 0)
        self.assertEqual(self.client.get('/rtis', params={'loco_no': '1' * 101}).status_code, 400)
